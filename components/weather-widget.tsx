...
export default function WeatherWidget() {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      ...
      <Card className="w-full max-w-md mx-auto text-center bg-blue-500 bg-opacity-10 shadow-lg shadow-blue-950">
        {/* Card header with title and description */}
        <CardHeader>
          <CardTitle className="text-2xl">My Weather Application</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          ...
          {weather && (
            <div className="mt-4 grid gap-2">
              ...
              <div className="flex items-center gap-2">
                <MapPinIcon className="w-6 h-6 text-yellow-700" />
